...
<<<<<<< HEAD
DEFAULT_INFO = [{"name": "Waiting for data...",}]


class BeholderPlugin(base_plugin.TBPlugin):
    """TensorBoard plugin for viewing model data as a live video during
    training."""
    ...
    def is_active(self):
        ...
        return tf.io.gfile.exists(summary_filename) and tf.io.gfile.exists(
            info_filename
        )
    ...
    def frontend_metadata(self):
        ...
        return base_plugin.FrontendMetadata(
            element_name="tf-beholder-dashboard", remove_dom=True,
        )
    ...
    def _serve_change_config(self, request):
        ...
        return http_util.Respond(
            request, {"config": config}, "application/json"
        )
    ...
    def _frame_generator(self):
        while True:
            ...
            response_content = (
                frame_text + content_type + image_bytes + b"\r\n\r\n"
            )
    ...
    def _serve_beholder_frame(self, request):  # pylint: disable=unused-argument
        ...
        return http_util.Respond(
            request, self._frame_generator(), mimetype, code=200
        )

    @wrappers.Request.application
    def _serve_ping(self, request):  # pylint: disable=unused-argument
        return http_util.Respond(
            request, {"status": "alive"}, "application/json"
        )
=======
DEFAULT_INFO = [{
